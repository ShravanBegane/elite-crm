<?php /* Smarty version Smarty-3.1.7, created on 2021-04-29 07:17:37
         compiled from "/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17561431016033492e254e21-89016141%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cab13734a89359c8330ab72fbb65e6ed76e7e370' => 
    array (
      0 => '/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/ListViewContents.tpl',
      1 => 1619680651,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17561431016033492e254e21-89016141',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6033492e32570',
  'variables' => 
  array (
    'MODULE_NAME' => 0,
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_6033492e32570')) {function content_6033492e32570($_smarty_tpl) {?>
...
<?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value==='Franchise'){?>
<iframe src="<?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
echo $site_URL; <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
franchisenew.php?link=Franchise" width="100%" height="550px" scrolling="no" style="margin-top:15px; border:0; overflow:hidden;" ></iframe>
<style>
.col-sm-12.col-xs-12 {
    display: none;
}
...
">
	...
	<?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value==='EmployeeRoaster'){?>
<iframe src="<?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
echo $site_URL; <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
roaster.php?link=roaster" width="100%" height="550px" style="margin-top:-15px;overflow:hidden;" ></iframe>
<?php }elseif($_smarty_tpl->tpl_vars['MODULE_NAME']->value==='Locationmap'){?>
<iframe src="<?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
echo $site_URL; <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
location.php?link=Locationmap" width="100%" height="550px" scrolling="no" style="margin-top:-15px;overflow:hidden;" ></iframe>
