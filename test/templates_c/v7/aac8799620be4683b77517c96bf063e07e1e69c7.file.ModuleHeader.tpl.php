<?php /* Smarty version Smarty-3.1.7, created on 2021-03-12 10:45:34
         compiled from "/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:306115029602fcde387def4-11282955%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aac8799620be4683b77517c96bf063e07e1e69c7' => 
    array (
      0 => '/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl',
      1 => 1615545931,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '306115029602fcde387def4-11282955',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_602fcde38d7f2',
  'variables' => 
  array (
    'MODULE' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_602fcde38d7f2')) {function content_602fcde38d7f2($_smarty_tpl) {?>
...
">&nbsp;&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
 &nbsp;&nbsp;</a></p><?php }?></div><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value==='Locationmap'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value==='EmployeeRoaster'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value==='Franchise'){?><?php }else{ ?><div class="col-lg-5 col-md-6 col-sm-7 col-xs-1 padding0 pull-right"><div id="appnav" class="navbar-right"><nav class="navbar navbar-inverse border0 margin0"><?php if (count($_smarty_tpl->tpl_vars['MODULE_BASIC_ACTIONS']->value)>0){?><div class="container-fluid"><div class="navbar-header bg-white marginTop5px"><button type="button" class="navbar-toggle collapsed margin0" data-toggle="collapse" data-target="#appnavcontent" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></button></div><div class="navbar-collapse collapse" id="appnavcontent" aria-expanded="false" style="height: 1px;"><ul class="nav navbar-nav"><?php  $_smarty_tpl->tpl_vars['BASIC_ACTION'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['BASIC_ACTION']->_loop = false;
...
</a></li><?php } ?></ul></div></li><?php }?></ul></div><!-- /.navbar-collapse --></div><!-- /.container-fluid --><?php }?></nav></div></div></div><?php }?><?php if ($_smarty_tpl->tpl_vars['FIELDS_INFO']->value!=null){?><script type="text/javascript">var uimeta = (function () {var fieldInfo = <?php echo $_smarty_tpl->tpl_vars['FIELDS_INFO']->value;?>
