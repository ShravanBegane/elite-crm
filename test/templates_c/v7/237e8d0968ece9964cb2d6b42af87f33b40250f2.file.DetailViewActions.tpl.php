<?php /* Smarty version Smarty-3.1.7, created on 2021-03-24 12:23:24
         compiled from "/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewActions.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1139075960335848a22a01-53257206%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '237e8d0968ece9964cb2d6b42af87f33b40250f2' => 
    array (
      0 => '/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/DetailViewActions.tpl',
      1 => 1616588600,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1139075960335848a22a01-53257206',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_60335848a544d',
  'variables' => 
  array (
    'RECORD' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_60335848a544d')) {function content_60335848a544d($_smarty_tpl) {?>
...
</button><?php } ?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='Campaigns'){?><button class="btn btn-default" id="Campaigns_detailView_basicAction_LBL_SEND_EMAIL"onclick="javascript:Vtiger_Detail_Js.triggerSendEmail('index.php?module=Campaigns&view=MassActionAjax&mode=showComposeEmailForm&step=step1','Emails');">Send Email</button><?php }?><?php if (!empty($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEW'])&&(count($_smarty_tpl->tpl_vars['DETAILVIEW_LINKS']->value['DETAILVIEW'])>0)){?><button class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="javascript:void(0);"><?php echo vtranslate('LBL_MORE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
