<?php /* Smarty version Smarty-3.1.7, created on 2021-03-15 12:06:19
         compiled from "/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:56675545960378b9a58add8-05562631%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fb75119294850db77bf1a3c1b48ab7a80de3cb97' => 
    array (
      0 => '/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/QuickCreate.tpl',
      1 => 1615809970,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '56675545960378b9a58add8-05562631',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_60378b9aac6c9',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_60378b9aac6c9')) {function content_60378b9aac6c9($_smarty_tpl) {?>
...
<div class="modal-body removeinlinestyle"><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
;return {field: {get: function(name, property) {if(name && property === undefined) {return fieldInfo[name];}if(name && property) {return fieldInfo[name][property]}},isMandatory : function(name){if(fieldInfo[name]) {return fieldInfo[name].mandatory;}return false;},getType : function(name){if(fieldInfo[name]) {return fieldInfo[name].type}return false;}},};})();</script><script type="text/javascript">$(document).ready(function(){setTimeout(function(){ $(".removeinlinestyle").removeAttr("style"); }, 100);})</script><?php }?></div><?php }} ?>