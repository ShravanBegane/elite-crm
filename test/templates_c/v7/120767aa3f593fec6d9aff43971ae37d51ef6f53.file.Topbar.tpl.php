<?php /* Smarty version Smarty-3.1.7, created on 2021-04-16 07:39:48
         compiled from "/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/partials/Topbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:845729764602fcde342bbc1-61574196%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '120767aa3f593fec6d9aff43971ae37d51ef6f53' => 
    array (
      0 => '/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Vtiger/partials/Topbar.tpl',
      1 => 1618558784,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '845729764602fcde342bbc1-61574196',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_602fcde34cdee',
  'variables' => 
  array (
    'MODULE' => 0,
...
<?php if ($_valid && !is_callable('content_602fcde34cdee')) {function content_602fcde34cdee($_smarty_tpl) {?>
...
"/></a></div></div></div></div><div class="navbar-header paddingTop5"><button type="button" class="navbar-toggle collapsed border0" data-toggle="collapse" onclick="setTimeout(marginetop, 100)" id="toggle1" data-target="#navbar" aria-expanded="false"><i class="fa fa-th"></i></button><button type="button" class="navbar-toggle collapsed border0" data-toggle="collapse" onclick="setTimeout(marginetop, 100)" id="toggle2" data-target="#search-links-container" aria-expanded="false"><i class="fa fa-search"></i></button></div><div class="col-sm-3"><div id="search-links-container" class="search-links-container collapse navbar-collapse"><div class="search-link"><span class="fa fa-search" aria-hidden="true" style='color:black;'></span><input class="keyword-input" type="text" placeholder="<?php echo vtranslate('LBL_TYPE_SEARCH');?>
" value="<?php echo $_smarty_tpl->tpl_vars['GLOBAL_SEARCH_VALUE']->value;?>
"><span id="adv-search" class="adv-search fa fa-chevron-circle-down pull-right cursorPointer" aria-hidden="true" style='color:black;'></span></div></div></div><div id="navbar" class="col-sm-6 col-xs-12 collapse navbar-collapse navbar-right global-actions"><ul class="nav navbar-nav"><li><div class="dropdown pull-left"><div class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><a href="#" id="menubar_quickCreate" class="qc-button fa fa-plus-circle" title="<?php echo vtranslate('LBL_QUICK_CREATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
</a></li></ul></div><?php }elseif($_smarty_tpl->tpl_vars['singularLabel']->value=='SINGLE_Locationmap'||$_smarty_tpl->tpl_vars['singularLabel']->value=='SINGLE_EmployeeRoaster'){?><div class="<?php if ($_smarty_tpl->tpl_vars['hideDiv']->value){?>create_restricted_<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
 hide<?php }else{ ?>col-lg-4 col-xs-4<?php }?>"><a id="menubar_quickCreate_<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
" class="quickCreateModule" data-name="<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
"data-url="" href="<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getDefaultUrl();?>
&app=RIGHTCLEAN"><?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getModuleIcon();?>
<span class="quick-create-module"><?php echo vtranslate($_smarty_tpl->tpl_vars['singularLabel']->value,$_smarty_tpl->tpl_vars['moduleName']->value);?>
</span></a></div><?php }else{ ?><div class="<?php if ($_smarty_tpl->tpl_vars['hideDiv']->value){?>create_restricted_<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
 hide<?php }else{ ?>col-lg-4 col-xs-4<?php }?>"><a id="menubar_quickCreate_<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
" class="quickCreateModule" data-name="<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getName();?>
"data-url="<?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getQuickCreateUrl();?>
" href="javascript:void(0)"><?php echo $_smarty_tpl->tpl_vars['moduleModel']->value->getModuleIcon();?>
...
function marginetop(){
    ...
    var toggle1 = $("#toggle1").attr('aria-expanded');
    var toggle2 = $("#toggle2").attr('aria-expanded');
    ...
    {
        $("nav + div + div").css("margin-top", "100px");
        //$(".tabContainer").css("margin-top", "100px");
        
    }
    else if(toggle1=="true" || toggle2=="true")
    {
        $("nav + div + div").css("margin-top", "50px");
        //$(".tabContainer").css("margin-top", "50px");
    }
    else{
        $("nav + div + div").css("margin-top", "0px");
         //$(".tabContainer").css("margin-top", "13px");
    }
};
</script><?php }} ?>