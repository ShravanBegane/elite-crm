<?php /* Smarty version Smarty-3.1.7, created on 2021-04-16 10:22:41
         compiled from "/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15397461886033c3ca3774f4-31907290%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '254456b493461b2c7602746a4e6c53ff6d073abc' => 
    array (
      0 => '/home/eliterightchoice/public_html/includes/runtime/../../layouts/v7/modules/Calendar/QuickCreate.tpl',
      1 => 1618568543,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '15397461886033c3ca3774f4-31907290',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_6033c3ca44e6f',
  'variables' => 
  array (
    'SCRIPTS' => 0,
    'jsModel' => 0,
...
<?php if ($_valid && !is_callable('content_6033c3ca44e6f')) {function content_6033c3ca44e6f($_smarty_tpl) {?>
<script>
...
<div class="modal-body"><ul class="calender-list-quick-create"><?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
</ul><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)){?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
</div><div class="muted col-sm-1" style="line-height: 67px;left: 20px; padding-right: 7%;"><span>Due</span></div><div class="col-sm-5" <?php if ($_smarty_tpl->tpl_vars['MODULE']->value=='Calendar'){?><?php }?>><?php $_smarty_tpl->tpl_vars["FIELD_MODEL"] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD_STRUCTURE']->value['due_date'], null, 0);?><?php echo $_smarty_tpl->getSubTemplate (vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
