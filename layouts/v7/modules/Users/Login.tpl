...
{strip}
	<style>
		body {
			background: url(layouts/v7/resources/Images/bg15.jpg);
	...
	<div class="container-fluid loginPageContainer">
		<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/vtigernew.png">
				<div>
			...
			<div class="marketingDiv">
										...
										{foreach item=BLOCK_DATA from=$BLOCKS_DATA}
											<li class="slide">
												...
												<div title="{$BLOCK_DATA.summary}">
													...
													<a href="{$BLOCK_DATA.url}" target="_blank"><u>{$BLOCK_DATA.urlalt}</u></a><br><br>
												</div>
												{if $BLOCK_DATA.image}
													</div>
												{else}
				...
				{else}
					<div class="inActiveImgDiv">
						<div>
							<h4>Get more out of RightChoice with extensions from</h4>
							<h4>RightChoice Marketplace</h4>
						</div>
						...
						<a href="#" style="margin-right: 25px;"><img src="layouts/v7/resources/Images/extensionstore.png" style="width: 85%; height: 100%; margin-top: 25px;"/></a>
					</div>
				{/if}
				</div>
			</div>
