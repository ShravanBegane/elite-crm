...
{strip}
    <div class="col-lg-6 detailViewButtoncontainer">
        <div class="pull-right btn-toolbar">
            ...
            <button class="btn btn-default" id="Campaigns_detailView_basicAction_LBL_SEND_EMAIL"onclick="javascript:Vtiger_Detail_Js.triggerSendEmail('index.php?module=Campaigns&view=MassActionAjax&mode=showComposeEmailForm&step=step1','Emails');">Send Email</button>
            {/if}
