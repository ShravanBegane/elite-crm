...
{if $MODULE_NAME === 'Franchise'}
<iframe src="{php}echo $site_URL; {/php}franchisenew.php?link=Franchise" width="100%" height="550px" scrolling="no" style="margin-top:15px; border:0; overflow:hidden;" ></iframe>
<style>
.col-sm-12.col-xs-12 {
    display: none;
}
...
<div class="col-sm-12 col-xs-12 ">
	...
	{if $MODULE_NAME === 'EmployeeRoaster'}
<iframe src="{php}echo $site_URL; {/php}roaster.php?link=roaster" width="100%" height="550px" style="margin-top:-15px;overflow:hidden;" ></iframe>
{else if $MODULE_NAME === 'Locationmap'}
<iframe src="{php}echo $site_URL; {/php}location.php?link=Locationmap" width="100%" height="550px" scrolling="no" style="margin-top:-15px;overflow:hidden;" ></iframe>
