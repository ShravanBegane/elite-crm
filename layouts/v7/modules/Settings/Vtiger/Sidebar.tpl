	...
	{if $USER_MODEL->isAdminUser()}
		...
		<div class="settingsgroup">
			...
			<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
			    <h5 style="margin-left: 20px;color: #fff;text-transform: uppercase;"> <a class="sidebar-icon" onMouseOver="this.style.color='#fff'"
   onMouseOut="this.style.color='#fff'" href="index.php?module=Franchise&view=List&app=MARKETING" >
						    <i class="indicator fa fa-chevron-right "></i> 
						    <span style="margin-left: 8px;">Franchise Settings</span> </a></h5>
