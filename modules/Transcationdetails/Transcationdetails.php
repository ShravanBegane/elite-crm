...
class Transcationdetails extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_transcationdetails';
	var $table_index= 'transcationdetailsid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_transcationdetailscf', 'transcationdetailsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_transcationdetails', 'vtiger_transcationdetailscf');
	...
	var $related_tables = Array( 
					'vtiger_transcationdetailscf' => Array('transcationdetailsid')
					);
	...
	var $tab_name_index = Array(
		...
		'vtiger_transcationdetails'   => 'transcationdetailsid',
	    'vtiger_transcationdetailscf' => 'transcationdetailsid');
	...
	var $list_fields = Array (
		...
		'Transcation No' => Array('transcationdetails', 'transcationdetailsno'),
/*'Transcationdetails No'=> Array('transcationdetails', 'transcationdetailsno'),*/
		'Assigned To' => Array('crmentity','smownerid')
	);
	var $list_fields_name = Array (
		/* Format: Field Label => fieldname */
		'Transcation No' => 'transcationdetailsno',
/*'Transcationdetails No'=> 'transcationdetailsno',*/
		'Assigned To' => 'assigned_user_id'
	);

	// Make the field link to detail view
	var $list_link_field = 'transcationdetailsno';
...
/*'Transcationdetails No'=> 'transcationdetailsno',*/
	...
	var $popup_fields = Array ('transcationdetailsno');

	// For Alphabetical search
	var $def_basicsearch_col = 'transcationdetailsno';

	// Column value to use on detail view record text display
	var $def_detailview_recname = 'transcationdetailsno';

	// Used when enabling/disabling the mandatory fields for the module.
	// Refers to vtiger_field.fieldname values.
	var $mandatory_fields = Array('transcationdetailsno','assigned_user_id');

	var $default_order_by = 'transcationdetailsno';
	...
	*/
	function vtlib_handler($moduleName, $eventType) {
		global $adb;
 		if($eventType == 'module.postinstall') {
			...
			Transcationdetails::checkWebServiceEntry();
			Transcationdetails::createUserFieldTable($moduleName);
			Transcationdetails::addInTabMenu($moduleName);
	...
	static function checkWebServiceEntry() {
		...
		$sql       =  "SELECT count(id) AS cnt FROM vtiger_ws_entity WHERE name = 'Transcationdetails'";
		...
		if($adb->num_rows($result) > 0)
		{
			...
			if($no == 0)
			{
				...
				$ws_entitySql = "INSERT INTO vtiger_ws_entity ( id, name, handler_path, handler_class, ismodule ) VALUES".
						  " (?, 'Transcationdetails','include/Webservices/VtigerModuleOperation.php', 'VtigerModuleOperation' , 1)";
