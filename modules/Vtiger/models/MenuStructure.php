...
class Vtiger_MenuStructure_Model extends Vtiger_Base_Model {
	...
	private function getEmptyMoreMenuList(){
		return array('CONTACT'=>array(), 'RIGHTCLEAN'=>array(),'MARKETING_AND_SALES'=>array(),'SUPPORT'=>array(),'INVENTORY'=>array(),'TOOLS'=>array(),'ANALYTICS'=>array());
	}
	...
	public static function getAppMenuList(){
		return array('RIGHTCLEAN','MARKETING','SALES','INVENTORY','SUPPORT','PROJECT','TOOLS');
	}

	public static function getAppIcons() {
		$appImageIcons = array(	'MARKETING' => 'fa-camera',
								'SALES'		=> 'fa-dot-circle-o',
								'SUPPORT'	=> 'fa-life-ring',
								'INVENTORY'	=> 'vicon-inventory',
								'PROJECT'	=> 'fa-briefcase',
								'TOOLS'		=> 'fa-wrench',
								'RIGHTCLEAN' => 'fa-hand-paper-o',
							);
