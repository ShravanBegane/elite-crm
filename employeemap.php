...
<html>
	<head>
		...
		<script src="layouts/v7/lib/jquery/jquery.min.js?v=7.1.0"></script>
		<script src="layouts/v7/lib/jquery/jquery-migrate-1.0.0.js?v=7.1.0"></script>
		<script type="text/javascript">
